...
// не думаю, что это хороший вариант, записывать профильные данные в токен, а затем при необходимости их извлекать, но здесь мы не делаем запрос в бд, хотя об актуальности таких данных под вопросом
//    @GetMapping()
